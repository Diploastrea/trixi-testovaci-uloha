            ...
            while (reader.hasNext()) {
                ...
                if (nextEvent.isStartElement()) {
                    ...
                    switch (fullTag) {
                        ...
                        case "obi:Nazev" -> {
                            nextEvent = reader.nextEvent();
                            town.setName(nextEvent.asCharacters().getData());
                        }
                        case "vf:CastObce" -> district = new District();
                        case "coi:Kod" -> {
                            nextEvent = reader.nextEvent();
                            district.setCode(Integer.parseInt(nextEvent.asCharacters().getData()));
                        }
                        case "coi:Nazev" -> {
                            nextEvent = reader.nextEvent();
                            district.setName(nextEvent.asCharacters().getData());
                        }
                    }
                }
